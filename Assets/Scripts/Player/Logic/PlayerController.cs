...
public class PlayerController : Singleton<PlayerController>
{
   ...
   private void OnLoadPlayer(CharacterDetails_SO data)
   {
      playerWeapon.weaponList = data.startWeaponList;
      playerHealth.maxHealth = data.startHealth;
      playerHealth.defense = data.startDefense;
